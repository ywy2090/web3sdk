...
/**
 * @description HTTP implementation of our services API.
 */
public class HttpService extends AbstractService {

    public static final String DEFAULT_URL = "http://127.0.0.1:8545/";
    ...
    public String sendSpecial(Request request) throws IOException {
        throw new UnsupportedOperationException("http service not support sendSpecial operation.");
    }

    @Override
    public <T extends Response> CompletableFuture<T> sendAsync(Request request, Class<T> responseType) throws UnsupportedOperationException {
        throw new UnsupportedOperationException(" sendAsync operation not support in Http service. ");
    }
