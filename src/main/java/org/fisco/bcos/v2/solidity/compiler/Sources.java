 ...
 */
package org.fisco.bcos.v2.solidity.compiler;

import static org.fisco.bcos.v2.solidity.compiler.ContractException.assembleError;
    ...
    public void resolveDependencies() {
        for (String srcName : artifacts.keySet()) {
            ...
            for (String dep : src.getDependencies()) {
                ...
                if (depArtifact == null) {
                    throw assembleError(
                            "can't resolve dependency: dependency '%s' not found.", dep);
                }
