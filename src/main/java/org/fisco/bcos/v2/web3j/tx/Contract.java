...
import org.fisco.bcos.v2.abi.EventValues;
import org.fisco.bcos.v2.abi.FunctionEncoder;
...
import org.fisco.bcos.v2.filter.BlockParameterName;
...
import org.fisco.bcos.v2.rpc.methods.request.Transaction;
...
import org.fisco.bcos.v2.web3j.tx.manager.ExtendedRawTransactionManager;
import org.fisco.bcos.v2.web3j.tx.manager.RawTransactionManager;
...
public abstract class Contract extends ManagedTransaction {
    ...
    public static TransactionManager getTheTransactionManager(
        ...
        JsonRpc2_0 jsonRpc2_0Web3j = (JsonRpc2_0) web3j;
        int groupId = jsonRpc2_0Web3j.getGroupId();
        String chainId = "1";
        String version = "";
        String supportedVersion = "";
        org.fisco.bcos.v2.rpc.methods.response.NodeVersion.Version nodeVersion = null;
        try {
            ...
            if (NodeVersion.BCOS_2_0_0_RC1.getVersion().equals(version)
                    || NodeVersion.BCOS_2_0_0_RC1.getVersion().equals(supportedVersion)) {
                version = NodeVersion.BCOS_2_0_0_RC1.getVersion();
        ...
        TransactionManager transactionManager =
                NodeVersion.BCOS_2_0_0_RC1.getVersion().equals(version)
    ...
    public boolean isValid() throws IOException {
        ...
        Code gcode = web3j.getCode(contractAddress).send();
        if (gcode.hasError()) {
            return false;
        }
    ...
    public void registerEventLogPushFilter(
        ...
        RpcService service = ((JsonRpc2_0) web3j).web3jService();

        ChannelService channelEthereumService = (ChannelService) service;
        // set timeout
        // filter.setTimeout(channelEthereumService.getTimeout());
        callback.setDecoder(decoder);

        channelEthereumService.getService().registerEventLogFilter(params, callback);
    }
    ...
    public void registerEventLogPushFilter(
        ...
        registerEventLogPushFilter(
                ...
                bin,
                topic0,
                new String(BlockParameterName.LATEST),
                new String(BlockParameterName.LATEST),
