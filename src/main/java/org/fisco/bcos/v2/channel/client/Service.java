...
import org.fisco.bcos.v2.channel.dto.*;
import org.fisco.bcos.v2.crypto.tools.PEMManager;
import org.fisco.bcos.v2.filter.EventLogFilter;
import org.fisco.bcos.v2.filter.EventLogFilterManager;
import org.fisco.bcos.v2.filter.EventLogFilterPushResponse;
import org.fisco.bcos.v2.filter.EventLogFilterPushStatus;
import org.fisco.bcos.v2.filter.EventLogFilterStatus;
import org.fisco.bcos.v2.filter.EventLogPushCallback;
import org.fisco.bcos.v2.filter.EventLogRequestParams;
import org.fisco.bcos.v2.filter.EventLogUserParams;
import org.fisco.bcos.v2.channel.handler.AMOPVerifyKeyInfo;
import org.fisco.bcos.v2.channel.handler.AMOPVerifyTopicToKeyInfo;
import org.fisco.bcos.v2.channel.handler.ChannelConnections;
import org.fisco.bcos.v2.channel.handler.ChannelHandlerContextHelper;
import org.fisco.bcos.v2.channel.handler.ConnectionCallback;
import org.fisco.bcos.v2.channel.handler.ConnectionInfo;
import org.fisco.bcos.v2.channel.handler.GroupChannelConnectionsConfig;
import org.fisco.bcos.v2.channel.handler.Message;
import org.fisco.bcos.v2.web3j.protocol.ChannelMessageError;
import org.fisco.bcos.v2.web3j.protocol.ChannelMessageType;
import org.fisco.bcos.v2.web3j.protocol.NodeRequestSdkVerifyTopic;
import org.fisco.bcos.v2.web3j.protocol.SdkRequestNodeUpdateTopicStatus;
import org.fisco.bcos.v2.web3j.protocol.TopicVerifyReqProtocol;
import org.fisco.bcos.v2.web3j.protocol.TopicVerifyRespProtocol;
import org.fisco.bcos.v2.web3j.protocol.parser.BlockNotificationParser;
import org.fisco.bcos.v2.web3j.protocol.parser.HeartBeatParser;
import org.fisco.bcos.v2.common.Strings;
...
public class Service {
    ...
    public BcosResponse sendEthereumMessage(
        ...
        class Callback extends BcosResponseCallback {
            private transient BcosResponse response;
    ...
    public void asyncSendEthereumMessage(BcosRequest request, BcosResponseCallback callback) {
        ...
        message.setSeq(request.getMessageID());
        message.setResult(0);
        message.setType((short) 0x12);
        message.setData(request.getContent().getBytes());
        // select node
        try {
            ...
            if (channelConnections == null) {
                ...
                throw new TransactionException("not active connection found");
            }
    ...
    public void asyncSendChannelMessage2(
            ChannelRequest request, ChannelResponseCallback callback) {
        try {
    ...
    public void onReceiveRegisterEventResponse(ChannelHandlerContext ctx, ChannelMessage message) {
    ...
    public void onReceiveEventLogPush(ChannelHandlerContext ctx, Message message) {
    ...
    public void onReceiveEthereumMessage(ChannelHandlerContext ctx, Message message) {
    ...
    public void onReceiveChannelMessage2(ChannelHandlerContext ctx, ChannelMessage message) {
    ...
    private void sendResponse2Node(ChannelHandlerContext ctx, Message message) {
        try {
    ...
    public void checkTopicVerify(ChannelHandlerContext ctx, Message message)
            throws IOException {
        SocketChannel socketChannel = (SocketChannel) ctx.channel();
    ...
    public void signForAmop(ChannelHandlerContext ctx, ChannelMessage message) throws IOException {
        SocketChannel socketChannel = (SocketChannel) ctx.channel();
        logger.info(
    ...
    public void onReceiveBlockNotify(ChannelHandlerContext ctx, ChannelMessage message) {
        try {
    ...
    public void onReceiveTransactionMessage(ChannelHandlerContext ctx, Message message) {
