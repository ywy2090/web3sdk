package org.fisco.bcos.v2.precompile.common;
...
import org.fisco.bcos.v2.rpc.methods.response.NodeVersion.Version;
...
public class PrecompiledCommon {
    ...
    public static String transferToJson(int code) throws IOException {
        ...
        if (BCOS_VERSION == null
                || NodeVersion.BCOS_2_0_0_RC1.getVersion().equals(BCOS_VERSION)) {
        ...
        } else if (NodeVersion.BCOS_2_0_0_RC2.getVersion().equals(BCOS_VERSION)) {
