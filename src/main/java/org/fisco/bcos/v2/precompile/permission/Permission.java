package org.fisco.bcos.v2.precompile.permission;
...
public class Permission extends Contract {
    ...
    public static RemoteCall<Permission> deploy(
        ...
        return deployRemoteCall(
                Permission.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<Permission> deploy(
        ...
        return deployRemoteCall(
                Permission.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
