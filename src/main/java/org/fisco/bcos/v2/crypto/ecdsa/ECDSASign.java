package org.fisco.bcos.v2.crypto.ecdsa;

import static org.fisco.bcos.v2.crypto.Sign.CURVE;
...
import org.fisco.bcos.v2.crypto.*;
...
public class ECDSASign implements SignInterface {
    ...
    public ECDSASignature sign(byte[] transactionHash, BigInteger privateKey) {
