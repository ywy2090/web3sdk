...
import static org.fisco.bcos.v2.common.Assertions.verifyPrecondition;
...
import org.fisco.bcos.v2.crypto.ecdsa.ECDSASign;
import org.fisco.bcos.v2.crypto.ecdsa.ECDSASignature;
...
public class Sign {
    ...
    //    public static SignatureData signMessage(byte[] message, ECKeyPair keyPair, boolean
    // needToHash) {
