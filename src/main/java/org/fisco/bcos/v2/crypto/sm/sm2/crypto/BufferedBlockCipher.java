package org.fisco.bcos.v2.crypto.sm.sm2.crypto;
...
public class BufferedBlockCipher {
     ...
     * @return the space required to accommodate a call to update and doFinal with 'length' bytes of
     *     input.
     */
     ...
     * @return the number of output bytes copied to out.
     * @exception DataLengthException if there is insufficient space in out for the output, or the
     *     input is not block size aligned and should be.
