...
import org.fisco.bcos.v2.abi.datatypes.StaticArray;
import org.fisco.bcos.v2.abi.datatypes.Type;
import org.fisco.bcos.v2.abi.datatypes.Utf8String;
import org.fisco.bcos.v2.abi.datatypes.generated.AbiTypes;
import org.fisco.bcos.v2.common.Collection;
...
import org.fisco.bcos.v2.abi.AbiDefinition;
import org.fisco.bcos.v2.abi.AbiDefinition.NamedType;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private static MethodSpec buildReturnTransactionDecoder() {
            ...
            if (typeNames.size() != 1) {
                ...
                if (innerType.dynamicArray()) { // dynamic array
                    return parameterSpec.name
                            + ".isEmpty()?org.fisco.bcos.v2.abi.datatypes.DynamicArray.empty"
                            + "(\""
                            + type
                            + "\"):"
                            + "new "
                            + parameterSpecType
                            + "(\n"
                            + "        org.fisco.bcos.v2.web3j.abi.Utils.typeMap("
                            + parameterSpec.name
                            + ", "
                            + typeMapInput
                            + "))";
    ...
    MethodSpec buildFunctionWithCallback(AbiDefinition functionDefinition)
        ...
        if (functionDefinition.isConstant()) {
            ...
            // "org.fisco.bcos.v2.channel.dto.FiscoResponse.TransactionSucCallback"));
            String inputParams = addParameters(methodBuilder, functionDefinition.getInputs());
    ...
    private MethodSpec buildFunctionWithInputDecoder(
        ...
        ParameterizedTypeName parameterizedTupleType =
                ParameterizedTypeName.get(
                        ClassName.get(
                                "org.fisco.bcos.v2.common.tuples", "Tuple" + returnTypes.size()),
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType =
                    ParameterizedTypeName.get(
                            ClassName.get(
                                    "org.fisco.bcos.v2.common.tuples",
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("org.fisco.bcos.v2.abi.datatypes.generated.StaticArray" + type);
