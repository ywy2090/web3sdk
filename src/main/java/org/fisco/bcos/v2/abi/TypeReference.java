 ...
 */
public abstract class TypeReference<T extends org.fisco.bcos.v2.abi.datatypes.Type>
    ...
    public static <T extends org.fisco.bcos.v2.abi.datatypes.Type> TypeReference<T> create(
            Class<T> cls) {
