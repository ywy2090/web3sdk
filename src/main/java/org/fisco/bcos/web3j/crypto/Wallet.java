 ...
 *
 * <p><strong>Note:</strong> we don't use the Bouncy Castle Scrypt implementation {@link
 * org.bouncycastle.crypto.generators.SCrypt}, as the following parameter assertion results in
 * failure of the Ethereum reference <a
