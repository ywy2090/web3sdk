...
public class BlockTransactionReceipts
    ...
    public static class BlockTransactionReceiptsInfo {
        ...
        private TransactionReceipts transactionReceipts;
        ...
        public TransactionReceipts getTransactionReceipts() {
            return transactionReceipts;
        }

        public void setTransactionReceipts(TransactionReceipts transactionReceipts) {
    ...
    public static class TransactionReceipts {
        ...
        @Override
        public String toString() {
            return "TransactionReceipts{" + "transactionReceipts=" + transactionReceipts + '}';
        }
    }
}
