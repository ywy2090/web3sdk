...
import org.fisco.bcos.v2.channel.test.contract.MixContract.CreateResultEventResponse;
import org.fisco.bcos.v2.channel.test.contract.MixContract.InsertResultEventResponse;
import org.fisco.bcos.v2.channel.test.contract.MixContract.RemoveResultEventResponse;
import org.fisco.bcos.v2.channel.test.contract.MixContract.UpdateResultEventResponse;
    ...
    public static void testMixContract(String[] args) throws Exception {
        ...
        if ("create".equals(args[0])) {
            ...
            List<CreateResultEventResponse> createResultEvents =
                    mixContract.getCreateResultEvents(receipt);
        ...
        // insert
            ...
            if (args.length == 4) {
                ...
                RemoteCall<TransactionReceipt> insert =
                        mixContract.insert(name, BigInteger.valueOf(item_id), item_name);
                TransactionReceipt txReceipt = insert.send();
                List<InsertResultEventResponse> insertResultEvents =
                        mixContract.getInsertResultEvents(txReceipt);
        ...
        // update
            ...
            if (args.length == 4) {
                ...
                RemoteCall<TransactionReceipt> update =
                        mixContract.update(name, BigInteger.valueOf(item_id), item_name);
                TransactionReceipt transactionReceipt = update.send();
                List<UpdateResultEventResponse> updateResultEvents =
                        mixContract.getUpdateResultEvents(transactionReceipt);
        ...
        // remove
            ...
            if (args.length == 3) {
                ...
                RemoteCall<TransactionReceipt> remove =
                        mixContract.remove(name, BigInteger.valueOf(item_id));
                TransactionReceipt transactionReceipt = remove.send();
                List<RemoveResultEventResponse> removeResultEvents =
                        mixContract.getRemoveResultEvents(transactionReceipt);
