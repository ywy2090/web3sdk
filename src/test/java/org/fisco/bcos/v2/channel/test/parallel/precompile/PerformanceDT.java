package org.fisco.bcos.v2.channel.test.parallel.precompile;
...
public class PerformanceDT {
    ...
    public static void Usage() {
        ...
        System.out.println(
                " \t java -cp conf/:lib/*:apps/* org.fisco.bcos.v2.channel.test.parallel.precompile.PerformanceDT groupID add count tps file.");
        System.out.println(
                " \t java -cp conf/:lib/*:apps/* org.fisco.bcos.v2.channel.test.parallel.precompile.PerformanceDT groupID transfer count tps file strategy.");
        System.exit(0);
    }
