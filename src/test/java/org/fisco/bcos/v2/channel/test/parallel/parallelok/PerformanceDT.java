package org.fisco.bcos.v2.channel.test.parallel.parallelok;
...
public class PerformanceDT {
    ...
    public static void Usage() {
        ...
        System.out.println(
                " \t java -cp conf/:lib/*:apps/* org.fisco.bcos.v2.channel.test.parallel.parallelok.PerformanceDT groupID add count tps file.");
        System.out.println(
                " \t java -cp conf/:lib/*:apps/* org.fisco.bcos.v2.channel.test.parallel.parallelok.PerformanceDT groupID transfer count tps file strategy.");
        System.out.println(
                " \t java -cp conf/:lib/*:apps/* org.fisco.bcos.v2.channel.test.parallel.parallelok.PerformanceDT groupID transferRevert count tps file strategy.");
        System.exit(0);
    }
