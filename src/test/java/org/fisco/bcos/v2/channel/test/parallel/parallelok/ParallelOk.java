    ...
    public RemoteCall<TransactionReceipt> registerParallelFunction(
        ...
        final Function function =
                new Function(
                        ...
                        Arrays.<Type>asList(
                                new org.fisco.bcos.v2.abi.datatypes.Utf8String(functionName),
                                new org.fisco.bcos.v2.abi.datatypes.generated.Uint256(
                                        criticalSize)),
    ...
    public RemoteCall<BigInteger> balanceOf(String name) {
        final Function function =
                new Function(
                        FUNC_BALANCEOF,
                        Arrays.<Type>asList(
                                new org.fisco.bcos.v2.abi.datatypes.Utf8String(name)),
    ...
    public RemoteCall<TransactionReceipt> transfer(String from, String to, BigInteger num) {
        final Function function =
                new Function(
                        FUNC_TRANSFER,
                        Arrays.<Type>asList(
                                new org.fisco.bcos.v2.abi.datatypes.Utf8String(from),
